...
public class LayoutAdmin extends JFrame {
	...
	public LayoutAdmin() {
		...
		// Số liệu quản lý
		JLabel lblBooksBorrowed = new JLabel(
				"SỐ LƯỢNG SÁCH ĐANG MƯỢN: " + layoutAdminController.getCountBooksBorrowed());
		...
		JLabel lblRegisteredReaders = new JLabel(
				"SỐ ĐỘC GIẢ ĐĂNG KÝ: " + layoutAdminController.getCountRegisteredReaders());
