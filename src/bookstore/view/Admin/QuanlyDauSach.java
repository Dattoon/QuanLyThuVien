...
public class QuanlyDauSach extends JFrame {
	...
	private JTextField textFieldSearch, textFieldMaSach, textFieldTuaSach, textFieldTomTat, textFieldSoLuong,
			textFieldMaNgonNgu, textFieldMaViTri;
	...
	public QuanlyDauSach() {
		...
		gl_inputFieldsPanel.setHorizontalGroup(gl_inputFieldsPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_inputFieldsPanel.createSequentialGroup().addGap(45).addGroup(gl_inputFieldsPanel
						...
						.addComponent(lblTomTat, GroupLayout.PREFERRED_SIZE, 96, GroupLayout.PREFERRED_SIZE)).addGap(4)
						.addGroup(gl_inputFieldsPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_inputFieldsPanel.createSequentialGroup()
										.addComponent(textFieldMaNgonNgu, GroupLayout.PREFERRED_SIZE, 189,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED, 396, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_inputFieldsPanel.createSequentialGroup().addGroup(gl_inputFieldsPanel
										.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_inputFieldsPanel.createSequentialGroup()
												.addComponent(textFieldTomTat, GroupLayout.PREFERRED_SIZE, 189,
														GroupLayout.PREFERRED_SIZE)
												.addGap(89)
												.addGroup(gl_inputFieldsPanel.createParallelGroup(Alignment.LEADING)
														.addGroup(gl_inputFieldsPanel.createSequentialGroup().addGap(12)
																.addComponent(lblMaViTri, GroupLayout.PREFERRED_SIZE,
																		92, GroupLayout.PREFERRED_SIZE))
														.addGroup(gl_inputFieldsPanel.createSequentialGroup().addGap(10)
																.addGroup(gl_inputFieldsPanel
																		.createParallelGroup(Alignment.LEADING)
																		...
																		.addComponent(lblSoLuong,
																				...
																				Short.MAX_VALUE)))))
										.addGroup(gl_inputFieldsPanel.createSequentialGroup()
												.addComponent(textFieldMaSach, GroupLayout.PREFERRED_SIZE, 189,
														GroupLayout.PREFERRED_SIZE)
												.addGap(197)))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(gl_inputFieldsPanel.createParallelGroup(Alignment.LEADING)
												.addComponent(textFieldMaViTri, GroupLayout.PREFERRED_SIZE, 189,
														GroupLayout.PREFERRED_SIZE)
												.addComponent(textFieldSoLuong, GroupLayout.PREFERRED_SIZE, 189,
														GroupLayout.PREFERRED_SIZE)
												.addComponent(textFieldTuaSach, GroupLayout.PREFERRED_SIZE, 189,
														GroupLayout.PREFERRED_SIZE))))
						.addGap(56)));
		gl_inputFieldsPanel.setVerticalGroup(
				gl_inputFieldsPanel.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
						gl_inputFieldsPanel.createSequentialGroup()
								.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(gl_inputFieldsPanel.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_inputFieldsPanel.createParallelGroup(Alignment.BASELINE)
												.addComponent(textFieldTuaSach, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(lblTuaSach, GroupLayout.PREFERRED_SIZE, 23,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(
												gl_inputFieldsPanel.createParallelGroup(Alignment.BASELINE)
														.addComponent(lblMaSach, GroupLayout.PREFERRED_SIZE, 23,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(
																textFieldMaSach, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
								.addGap(10)
								.addGroup(gl_inputFieldsPanel.createParallelGroup(Alignment.LEADING).addGroup(
										gl_inputFieldsPanel.createSequentialGroup().addGroup(gl_inputFieldsPanel
												.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_inputFieldsPanel.createSequentialGroup()
														.addGroup(gl_inputFieldsPanel
																...
																.addComponent(
																		textFieldSoLuong, GroupLayout.PREFERRED_SIZE,
														...
														.addGroup(gl_inputFieldsPanel
																...
																.addComponent(lblMaViTri, GroupLayout.PREFERRED_SIZE,
																		23, GroupLayout.PREFERRED_SIZE)
																.addComponent(textFieldMaViTri,
																		GroupLayout.PREFERRED_SIZE,
																		GroupLayout.DEFAULT_SIZE,
																		GroupLayout.PREFERRED_SIZE)))
												.addComponent(lblTomTat, GroupLayout.PREFERRED_SIZE, 23,
														GroupLayout.PREFERRED_SIZE))
												.addPreferredGap(ComponentPlacement.RELATED)
												.addGroup(gl_inputFieldsPanel.createParallelGroup(Alignment.BASELINE)
														.addComponent(lblMaNgonNgu, GroupLayout.PREFERRED_SIZE, 23,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(textFieldMaNgonNgu, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
										.addComponent(textFieldTomTat, GroupLayout.PREFERRED_SIZE, 41,
												GroupLayout.PREFERRED_SIZE))
								.addContainerGap()));
