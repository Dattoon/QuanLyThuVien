	...
	public QuanlyDocGia() {
		...
		gl_formPanel.setHorizontalGroup(gl_formPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_formPanel
				...
				.addGroup(gl_formPanel.createParallelGroup(Alignment.LEADING, false)
						.addComponent(lblMaDocGia, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
								GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(lblDiaChi, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						.addComponent(lblDienThoai, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
								GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				...
				.addGroup(gl_formPanel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(Alignment.TRAILING, gl_formPanel.createSequentialGroup().addGroup(gl_formPanel
								...
								.addComponent(txtDienThoai, GroupLayout.PREFERRED_SIZE, 181,
										GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED, 63, Short.MAX_VALUE)
								.addGroup(gl_formPanel.createParallelGroup(Alignment.LEADING)
										.addComponent(lblTenDocGia, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 91,
												GroupLayout.PREFERRED_SIZE)
										.addGroup(gl_formPanel.createParallelGroup(Alignment.TRAILING, false)
												.addComponent(lblNgaySinh, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(lblMaThe, GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_formPanel.createParallelGroup(Alignment.LEADING)
										.addComponent(txtNgaySinh, GroupLayout.PREFERRED_SIZE, 181,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(txtTenDocGia, GroupLayout.PREFERRED_SIZE, 181,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(txtMaThe, GroupLayout.PREFERRED_SIZE, 181,
												GroupLayout.PREFERRED_SIZE))
								.addGap(141)))));
		gl_formPanel.setVerticalGroup(gl_formPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_formPanel
				...
				.addGroup(gl_formPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_formPanel.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(txtTenDocGia, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_formPanel.createParallelGroup(Alignment.BASELINE)
				...
				.addGroup(gl_formPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_formPanel
						...
						.addGroup(gl_formPanel.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(txtDienThoai, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(10)
						.addGroup(gl_formPanel.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblNgayHetHan, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)
								.addComponent(txtNgayHetHan, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_formPanel.createParallelGroup(Alignment.BASELINE)
		...
		gl_tablePanel.setHorizontalGroup(gl_tablePanel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(Alignment.TRAILING,
						gl_tablePanel.createSequentialGroup().addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		gl_tablePanel.setVerticalGroup(gl_tablePanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_tablePanel.createSequentialGroup().addContainerGap()
						.addComponent(formPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
