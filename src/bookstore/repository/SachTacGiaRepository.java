...
public class SachTacGiaRepository extends BaseRepository<SachTacGiaModel> {
    ...
    private static final String INSERT_QUERY = "INSERT INTO SachTacGia (MaSach, MaTG) VALUES (?, ?)";
    private static final String DELETE_BY_MASACH_QUERY = "DELETE FROM SachTacGia WHERE MaSach = ?";
    private static final String DELETE_BY_MATACGIA_QUERY = "DELETE FROM SachTacGia WHERE MaTG = ?";
    private static final String SELECT_ALL_QUERY = "SELECT * FROM SachTacGia";
